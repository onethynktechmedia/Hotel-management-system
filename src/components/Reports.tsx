      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        <div className="flex flex-wrap items-center gap-4">
          ...
          <button
            ...
            className="ml-auto flex items-center gap-2 bg-gradient-to-r from-green-600 to-emerald-600 text-white px-4 py-2 rounded-xl font-semibold hover:shadow-lg transition-all duration-300"
          >
        ...
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gradient-to-r from-orange-100 to-amber-100">
              <tr>
                <th className="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Dish Name</th>
          ...
          <table className="w-full">
            <thead className="bg-gradient-to-r from-orange-100 to-amber-100 sticky top-0">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Table</th>
                <th className="px-6 py-3 text-left text-xs font-bold text-gray-700 uppercase">Waiter</th>
